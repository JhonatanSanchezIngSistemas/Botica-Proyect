Proyecto Botica - resoluci髇 de conflicto: se conservaron cambios de MAIN y FEATURE.\r\n\r\n<<<<<<< HEAD
Proyecto Botica - versi髇 feature (cambio conflictivo en FEATURE)
=======
Proyecto Botica - versi髇 principal (cambio conflictivo en MAIN)
>>>>>>> main
...
- Evidencia de resoluci髇 de conflicto: (placeholder)
